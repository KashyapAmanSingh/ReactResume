...
const KeySkills = ({ register, errors,control }) => {
  ...
  return (
    ...
    <div className="col-md-6">
      <label className="form-label" htmlFor="KeySkill.experienceLevel">Experience level:</label>
      <input
        type="date"
      ...
      />
      <p className="error-message">{errors.experienceLevel?.message}</p>
    </div>
    ...
    <div className="col-md-6">
      <label className="form-label" htmlFor="hobby">Your Hobby:</label>
      <input
        type="date"
        className="form-control"
        id="hobby"
